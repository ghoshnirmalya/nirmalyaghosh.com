---
date: "2020-06-17"
title: "How to Create a Flexible Pagination Component with React"
category: "React"
tags: ["react.js"]
...
![Banner](/images/content/how-to-create-an-accessible-pagination-component-with-react/1.svg)

> In this tutorial, we'll explain all the things that are necessary to build an
...
A Pagination component is useful for fetching fragments of data and show it to
the user. The user can control when they want to view the next set of data. In a
Pagination component, the user can also control the amount of data that they
want to view.

![View with page-size selector](/images/content/how-to-create-an-accessible-pagination-component-with-react/2.svg)
...
![View with page-number selector](/images/content/how-to-create-an-accessible-pagination-component-with-react/3.svg)
...
For example, initially a set of 5 rows out of 100 rows will be fetched from the
server and rendered on the list or table. When the user scrolls to the bottom of the
list or table, the next 5 rows are fetched from the server and shown.

It's also possible that the whole data is fetched initially but the rows are
...
[This
article](https://uxplanet.org/ux-infinite-scrolling-vs-pagination-1030d29376f1)
...
![Client-side pagination](/images/content/how-to-create-an-accessible-pagination-component-with-react/4.svg)
...
![Server-side pagination](/images/content/how-to-create-an-accessible-pagination-component-with-react/5.svg)
...
![Server-side pagination view](/images/content/how-to-create-an-accessible-pagination-component-with-react/6.svg)
