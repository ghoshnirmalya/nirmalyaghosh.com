...
lastmod: "2021-10-10T10:36:42.967Z"
draft: false
tags:
  - next.js
categories:
...
Imagine that you are building an e-commerce application which has hundreds of pages. You can generate the HTML of all those pages during the build time by leveraging [Static Site Generation (or SSG)](https://nextjs.org/docs/basic-features/data-fetching#getstaticprops-static-generation).
...
There is another example on [this page](https://nextjs.org/docs/basic-features/data-fetching#incremental-static-regeneration) which also shows how the [`getStaticPaths`](https://nextjs.org/docs/basic-features/data-fetching#getstaticpaths-static-generation) function works inside ISR.

The re-generation of the page happens in the background. Based on the availability of the new content, the cache is invalidated.
