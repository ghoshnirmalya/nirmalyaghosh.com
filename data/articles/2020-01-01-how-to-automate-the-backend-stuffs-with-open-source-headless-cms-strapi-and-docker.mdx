...
lastmod: 2023-01-03T17:20:29.435Z
categories:
  - docker
keywords:
  - Docker
...
Now, we want to add a **Product** content-type. To do so, we need to click on the **Create new content-type** link. In the **Display Name** field, we can type **Product**:
